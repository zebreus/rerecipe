      ...
      steps: [
        {
          ...
          durationMin: 2,
          agitationLevel: "low",
          additionIngredients: ["ing-2", "ing-1", "ing-3"],
          holdConditions: "",
        ...
        },
        {
          ...
          description: "Transfer to pot, add modified starch and carrageenan",
          temperatureC: 85,
          durationMin: 3,
          agitationLevel: "high",
          additionIngredients: ["ing-5", "ing-6"],
          holdConditions: "",
        ...
        },
        {
          ...
          durationMin: 25,
          agitationLevel: "low",
          additionIngredients: ["ing-4", "ing-7"],
