  ...
  function handleCreateVariations(f: Formula) {
    ...
    const newFormulas: Formula[] = variations.map((v) => {
      ...
      return {
        ...
        calculatedNutrition: calculateFormulaNutrition(
          lines,
          data.ingredients,
  ...
  const comparisonData = useMemo(
    () =>
      data.formulas.length > 0
        ? data.targetProduct.targetNutrition.map((n) => {
        ...
        : [],
    [data.formulas, data.targetProduct.targetNutrition, data.ingredients]
  );
          ...
          <Card className="col-span-full">
            <CardContent>
              <EmptyState
                ...
                subtitle="Create a new formula and add ingredient lines to start formulating."
              />
            </CardContent>
          </Card>
        ) : (
